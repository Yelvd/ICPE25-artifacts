...
new_columns = ["Benchmark", "Platform", "Processes", "Region", names["runtime"], names["instructions"], names["cycles"], "CPI", "mem-request/inst"]
new_df = []
...
for job in np.unique(df['unique']):
    ...
    new_df.append([benchmark, platform, tasks, region, t, i, c, cpi, dpi])
    pass
