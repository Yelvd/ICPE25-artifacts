...
CPUs = ["AMD", "ARM", "INTEL", "INTEL_HBM", "Archer2"]

df = pd.read_csv("../results/Eviden-results.csv", sep=';')

# PLOT FIXED
df_fixed = df.loc[df["benchmark"] == "small"]
...
#Archer
archer = {"Time": 476, "Energy": 202, "Power": 420}
...
ax.set_title('Results for relative size benchmark')
ax.set_xticks(x*1.5 + .5, CPUs)
# ax.legend(loc='upper left', ncols=3)
ax.legend(ncols=4)
ax.set_ylim(0)

plt.savefig("../figs/eviden_small_time_bar.png", dpi=300)
