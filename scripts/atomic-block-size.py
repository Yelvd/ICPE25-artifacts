...
results_dir = "../results-atomic-block-size/"
exp = None
iterations = 1000
...
# plt.xticks(x)
plt.savefig("../artifacts-presentation/model.png", dpi=300)
...
plt.ylim(0*10**-8)
plt.savefig("../artifacts-presentation/Time_per_LU.png", dpi=300)
# plt.show()
...
plt.legend()
plt.savefig("../artifacts-presentation/energy.png", dpi=300)
# plt.show()
