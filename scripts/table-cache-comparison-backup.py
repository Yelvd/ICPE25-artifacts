...
new_columns = ["benchmark", "platform", "tasks", names["instructions"], names["l1_accesses"], names["l1_misses"], "miss-rate", "Mem ops / inst"]
for job in np.unique(df['unique']):
    ...
    new_df.append([r['benchmark'].values[0], r['platform'].values[0], r['tasks'].values[0], i, ca, cr, miss_rate, mpi])
